...
reader <- read.csv2("/home/vinicius/PIPEL2/resultados/graficosr/heatmap.out", sep=";")
...
scale_fill_gradient('Resources Utilization (%)', limits=c(0, 100),  low = "yellow", high = "black") 
