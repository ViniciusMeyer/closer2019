...
reader <- read.csv2("/home/vinicius/PIPEL2/resultados/graficosr/energy.csv", sep=";")
...
ggplot(reader) +
  geom_bar( aes(x=Scenario, y=Energy), stat="identity", fill="brown", alpha=0.7) +
  #geom_errorbar( aes(x=Scenario, ymin=Energy-sd, ymax=Energy+sd), width=0.4, colour="black", alpha=0.9, size=0.5)+
