...
reader <- read.csv2("/home/vinicius/PIPEL2/resultados/graficosr/aaaa.csv", sep=";")
...
ggplot(reader) +
  geom_bar( aes(x=Scenario, y=Speedup), stat="identity", fill="skyblue", alpha=0.7) +
  #geom_errorbar( aes(x=Scenario, ymin=Speedup-sd, ymax=Speedup+sd), width=0.4, colour="black", alpha=0.9, size=0.5)+
